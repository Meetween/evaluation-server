...
def main():
    ...
    try:
        ...
        scores = {"perception_paralinguistics_accuracy": -1,
                  "perception_linguistics_accuracy": -1,
                  "reasoning_paralinguistics_accuracy": -1,
                  "reasoning_linguistics_accuracy": -1,
                  "perception_accuracy": -1,
                  "reasoning_accuracy": -1}

        if "Perception" in task_category_accuracies:
            if "Paralinguistics" in task_category_accuracies["Perception"]:
                scores["perception_paralinguistics_accuracy"] = task_category_accuracies["Perception"]["Paralinguistics"]
            if "Linguistics" in task_category_accuracies["Perception"]:
                scores["perception_linguistics_accuracy"] = task_category_accuracies["Perception"]["Linguistics"]
        if "Reasoning" in task_category_accuracies:
            if "Paralinguistics" in task_category_accuracies["Reasoning"]:
                scores["reasoning_paralinguistics_accuracy"] = task_category_accuracies["Reasoning"]["Paralinguistics"]
            if "Linguistics" in task_category_accuracies["Reasoning"]:
                scores["reasoning_linguistics_accuracy"] = task_category_accuracies["Reasoning"]["Linguistics"]
        if "Perception" in task_average_accuracies:
            scores["perception_accuracy"] = task_average_accuracies["Perception"]["average_accuracy"]
        if "Reasoning" in task_average_accuracies:
            scores["reasoning_accuracy"] = task_average_accuracies["Reasoning"]["average_accuracy"]
...
# --------------------------------------------------------
# 7 scores:
#  - 'perception_paralinguistics_accuracy' (1010 entries)
#  - 'perception_linguistics_accuracy' (1570 entries)
#  - 'reasoning_linguistics_accuracy' (2085 entries)
#  - 'reasoning_paralinguistics_accuracy' (335 entries)
#  - 'perception_accuracy' (2580 entries)
#  - 'reasoning_accuracy' (2420 entries)
#  - 'overall_accuracy' (5000 entries)
# --------------------------------------------------------
# Category: Perception, Sub-category: Paralinguistics, Accuracy: 1.0000
# Category: Perception, Sub-category: Linguistics, Accuracy: 1.0000
# Category: Perception, Average Accuracy: 1.0000
